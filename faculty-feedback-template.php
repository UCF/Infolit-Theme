<?php
/*
Template Name: Faculty Feedback Template
*/
...
?>
    ...
    <form method="post" id="faculty-feedback-form" action="https://formmanager.ucf.edu/formsubmit.cfm">
        ...
        <fieldset>
            ...
            <ol>
            	<li>
                	<label for='First_Choice_Topic'>From the pull-down menu, select the topic you would rank as your FIRST CHOICE as a topic for a new information literacy module:</label><br />
                ...
                <li>
                	<label for='Second_Choice_Topic'>From the pull-down menu, select the topic you would rank as your SECOND CHOICE as a topic for a new information literacy module:</label><br />
                 ...
                 <li>
                 	<label for='Third_Choice_Topic'>From the pull-down menu, select the topic you would rank as your THIRD CHOICE as a topic for a new information literacy module:</label><br />
                ...
                <li>
                	<label for='Modules_Used_Past'>Please select the title of each information literacy module you have used in the past. (Hold down the control key to select more than one module title):</label><br />
                ...
                <li>
                	<label for='Module_Feedback'>Please provide any feedback on the modules you've used that would make these modules better resources for assignment by UCF faculty.</label><br />
                	<textarea name='Module_Feedback' id='Module_Feedback' cols='0' rows='0'></textarea>
                </li>
            </ol>
            	<input type="hidden" name="id" value="27838" class="hide" />
